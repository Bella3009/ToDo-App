...
while True:
    ...
    if user_action == "add":
        task = Error_Handling.int_input("How many tasks you want to add: ",
                                        "You need to enter the number of tasks you want to add ")
        ...
        task_list = Error_Handling.int_input("Type the number of the task you want to edit: ",
                                             "You need to enter the number of the task to edit it.")
        ...
        ToDo_Macro.show_todos()
        todo_list = ToDo_Macro.get_todos()
        task_list = Error_Handling.int_input("Type the number of the task you want to mark as complete: ",
                                             "You need to enter the number of the task to mark it as complete.")
